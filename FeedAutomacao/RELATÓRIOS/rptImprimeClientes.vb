...
Public Class rptImprimeClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FeedAutomacao.rptImprimeClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImprimeClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImprimeClientes = New rptImprimeClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
