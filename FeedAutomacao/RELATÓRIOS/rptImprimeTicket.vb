...
Public Class rptImprimeTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FeedAutomacao.rptImprimeTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImprimeTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImprimeTicket = New rptImprimeTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
